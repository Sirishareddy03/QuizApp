...
const QaCard = ({questionData,questionNumber,totalQuestion,handleAnswer,quitQuiz}) => {
  return (
    <div className='card shadow my-2 p-3'>
      ...
      <div className='card-header d-flex justify-content-between p-2 bg-primary text-white fw-bold 'style={{marginTop:'50px'}}>
      <h6>TotalQuestion:{questionNumber}of{totalQuestion}</h6>
